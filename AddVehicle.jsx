    ...
    >
      ...
      <main className="p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`mt-4 w-full py-3 text-xl font-semibold rounded-full ${theme === "dark" ? "bg-blue-600 text-white hover:bg-blue-500" : "bg-blue-400 text-black hover:bg-blue-300"}`}
          >
            Add Vehicle
          </button>
        </form>
